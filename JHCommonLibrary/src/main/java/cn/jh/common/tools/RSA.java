...
public class RSA {
    ...
    public  String sign(String data, String pfx_path, String key_pass) {
    ...
    public  String signSHA(String data, String pfx_path, String key_pass) {
	...
	public  String encrypt(String data,String pub_key) {
		
		try {
			logger.debug("进入encrypt方法");
	        KeyFactory rsaKeyFac = KeyFactory.getInstance("RSA");
	        logger.debug("rsaKeyFac===="+rsaKeyFac.toString());
	        X509EncodedKeySpec keySpec = new X509EncodedKeySpec(Base64.decode(pub_key));
	        logger.debug("keySpec===="+keySpec.toString());
	        RSAPublicKey pbk = (RSAPublicKey) rsaKeyFac.generatePublic(keySpec);
	        logger.debug("pbk===="+pbk.toString());
			Cipher cipher = Cipher.getInstance("RSA/ECB/PKCS1PADDING");
			logger.debug("cipher===="+cipher.toString());
			cipher.init(Cipher.ENCRYPT_MODE, pbk);
			
			byte[] encDate = cipher.doFinal(data.getBytes(ENCODING));
			logger.debug("encDate===="+encDate.toString());
		...
		public  byte[] encrypt64(String data,String pub_key) {
    ...
    public  String decrypt(String sign_msg, String pfx_path, String pfx_pass) {
    ...
    public  boolean verify(String data, String pub_key, String value) {
    ...
    public  boolean verifySHA(String data, String pub_key, String value) {
    ...
    public  RSAPrivateKey getPrivateKey(String keyPath, String passwd) throws Exception {
    ...
    public  RSAPublicKey getPublicKey(String keyPath, String passwd) throws Exception {
