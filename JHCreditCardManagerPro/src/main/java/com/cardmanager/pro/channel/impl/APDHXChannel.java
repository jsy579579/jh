...
@Component
public class APDHXChannel extends ChannelRoot implements ChannelBaseAPI {

    /**
     * 还款对接
     *
     */
    private final static String IS_REGISTER_TO_CHANNEL_URL = "/v1.0/paymentgateway/topup/apdhx/Dockentrance";

    /**
     * 查询商户钱包
     *
     */
    private final static String GET_CHANNEL_URL_ACCOUNT_RUL = "/v1.0/paymentgateway/topup/apdhx/balancequery";
    /**
     * 查询消费状态
     *
     */
    private final static String GET_CONSUME_ORDER_STATUS_URL = "/v1.0/paymentgateway/topup/apdhx/orderquery";
    /**
     * 查询提现状态
     *
     */
    private final static String GET_REPAYMENT_ORDER_STATUS_URL = "/v1.0/paymentgateway/topup/apdhx/transferquery";
