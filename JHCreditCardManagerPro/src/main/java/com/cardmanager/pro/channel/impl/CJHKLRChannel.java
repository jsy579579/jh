...
@Component
public class CJHKLRChannel extends ChannelRoot implements ChannelBaseAPI {
	/**
	 * 查询商户钱包
	 * 
	 */
	 ...
	 * 
	 */
	private final static String IS_REGISTER_TO_CHANNEL_URL = "/v1.0/paymentgateway/topup/cjhklr/dockingEntrance";
