...
@Component
public class CJHKLRChannel2 extends ChannelRoot implements ChannelBaseAPI {
	/**
	 * 查询商户钱包
	 * 
	 */
	private final static String GET_CHANNEL_URL_ACCOUNT_RUL = "/v1.0/paymentgateway/topup/cjhk/walletQuery";
	/**
	 * 查询消费状态
	 * 
	 */
	private final static String GET_CONSUME_ORDER_STATUS_URL = "/v1.0/paymentgateway/topup/cjhk/consumeQuery";
	/**
	 * 查询提现状态
	 * 
	 */
	private final static String GET_REPAYMENT_ORDER_STATUS_URL = "/v1.0/paymentgateway/topup/cjhk/withdrawQuery";
	/**
	 * 还款对接
	 * 
	 */
	private final static String IS_REGISTER_TO_CHANNEL_URL = "/v1.0/paymentgateway/topup/cjhklr/dockingEntrance2";
