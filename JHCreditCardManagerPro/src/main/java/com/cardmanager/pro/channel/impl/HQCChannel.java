...
@Component
public class HQCChannel extends ChannelRoot implements ChannelBaseAPI {
	
	private final static String GET_CHANNEL_URL_ACCOUNT_RUL = "/v1.0/paymentgateway/topup/hq/balancequery";

	private final static String GET_ORDER_STATUS_URL = "/v1.0/paymentgateway/topup/hq/orderquery";
	
	private final static String IS_REGISTER_TO_CHANNEL_URL = "/v1.0/paymentgateway/topup/hq/torepayment";
