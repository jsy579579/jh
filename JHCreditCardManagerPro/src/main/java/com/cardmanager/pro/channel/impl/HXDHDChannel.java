 ...
 * @description: TODO
 * @author: huhao
 * @date: 2019/8/16 20:56
 */
@Component
public class HXDHDChannel extends ChannelRoot implements ChannelBaseAPI {

    private static final Logger LOG = LoggerFactory.getLogger(HXDHDChannel.class);

    private final static String GET_CHANNEL_URL_ACCOUNT_RUL = "/v1.0/paymentgateway/topup/hxdhd/balance/query/card";  //根据银行卡查询余额

    private final static String GET_CONSUME_ORDER_STATUS_URL = "/v1.0/paymentgateway/topup/hxdhd/orderquery";    //查询订单状态

    private final static String GET_REPAYMENT_ORDER_STATUS_URL = "/v1.0/paymentgateway/topup/hxdhd/transferquery";// 结算状态查询

    private final static String IS_REGISTER_TO_CHANNEL_URL = "/v1.0/paymentgateway/topup/hxdhd/dockingEntrance";  //是否进件
