...
@Component
public class HXDHXChannel extends ChannelRoot implements ChannelBaseAPI {
    private static final Logger LOG = LoggerFactory.getLogger(HXDHXChannel.class);


    private final static String GET_CHANNEL_URL_ACCOUNT_RUL = "/v1.0/paymentgateway/topup/hxdhx/balancequery";

    private final static String GET_CONSUME_ORDER_STATUS_URL = "/v1.0/paymentgateway/topup/hxdhx/orderquery";

    private final static String GET_REPAYMENT_ORDER_STATUS_URL = "/v1.0/paymentgateway/topup/hxdhx/transferquery";

    private final static String IS_REGISTER_TO_CHANNEL_URL = "/v1.0/paymentgateway/topup/hxdhx/dockingEntrance";
