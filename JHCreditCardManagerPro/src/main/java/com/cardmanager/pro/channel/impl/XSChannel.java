...
@Component
public class XSChannel extends ChannelRoot implements ChannelBaseAPI {
	
	private final static String GET_CHANNEL_URL_ACCOUNT_RUL = "/v1.0/paymentgateway/xs/repayment/query/balance";

	private final static String GET_ORDER_STATUS_URL = "/v1.0/paymentgateway/xs/query/order/status";
	
	private final static String IS_REGISTER_TO_CHANNEL_URL = "/v1.0/paymentgateway/xs/repayment/isbindcard";
