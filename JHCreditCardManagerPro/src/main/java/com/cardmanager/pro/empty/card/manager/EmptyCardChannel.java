...
@Component
public class EmptyCardChannel extends ChannelRoot implements ChannelBaseAPI {
	
	private final static String GET_CHANNEL_URL_ACCOUNT_RUL = "/v1.0/paymentgateway/xs/repayment/query/balance";

	private final static String GET_ORDER_STATUS_URL = "/v1.0/paymentgateway/topup/hqekk/orderquery";
	
	private final static String IS_REGISTER_TO_CHANNEL_URL = "/v1.0/paymentgateway/topup/hqekk/bindCard";
	
	{
		this.setRepaymentTaskExecutor(EmptyCardRepaymentTaskExecutor.class);
		this.setRepaymentTaskCheckor(EmptyCardRepaymentTaskCheckor.class);
		this.setConsumeTaskExecutor(EmptyCardConsumeTaskExecutor.class);
		this.setConsumeTaskCheckor(EmptyCardConsumeTaskCheckor.class);
	}
