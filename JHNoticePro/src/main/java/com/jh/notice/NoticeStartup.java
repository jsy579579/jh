...
public class NoticeStartup extends WebMvcConfigurerAdapter {
	...
	public static void main(String[] args) throws Exception {
		...
		SpringApplication.run(NoticeStartup.class, args);
	}
	...
	public void addInterceptors(InterceptorRegistry registry) {
		registry.addInterceptor(new AuthenticationHeaderInterceptor())
				.addPathPatterns("/**");
	}
