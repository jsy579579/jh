...
public class BankAbbr {
	...
	public static final String BCOM = "BCOM"; // 交通银行
	...
	public static final String CZB = "CZB"; // 浙商银行
	public static final String BOB = "BOB"; // 北京银行
	public static final String PAB = "PAB"; // 平安银行
	public static final String HCCB = "HCCB"; // 杭州银行
	public static final String NJCB = "NJCB"; // 南京银行
	public static final String BRCB = "BRCB"; // 北京农村商业银行
