...
import com.jh.paymentgateway.controller.HQEKKpageRequest;
import com.jh.paymentgateway.pojo.PaymentRequestParameter;

@Service
public class HQEKKTopupPage extends BaseChannel implements  TopupRequestBusiness{

	private static final Logger LOG = LoggerFactory.getLogger(HQEKKTopupPage.class);

	@Value("${payment.ipAddress}")
	private String ip;
	
	@Autowired
	private HQEKKpageRequest hqePageRequst;
	...
	public Map<String, Object> topupRequest(Map<String, Object> params) throws Exception {
		...
		if("11".equals(orderType)) {
			...
			map = (Map<String, Object>) hqePageRequst.loan(orderCode);
