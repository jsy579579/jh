...
import com.jh.paymentgateway.controller.HQEpageRequest;
import com.jh.paymentgateway.pojo.PaymentRequestParameter;

@Service
public class HQETopupPage extends BaseChannel implements  TopupRequestBusiness{

	private static final Logger LOG = LoggerFactory.getLogger(HQETopupPage.class);

	@Value("${payment.ipAddress}")
	private String ip;
	
	@Autowired
	private HQEpageRequest hqePageRequst;
