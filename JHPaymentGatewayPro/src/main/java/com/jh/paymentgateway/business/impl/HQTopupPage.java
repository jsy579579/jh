...
@Service
public class HQTopupPage extends BaseChannel implements  TopupRequestBusiness{

	private static final Logger LOG = LoggerFactory.getLogger(HQTopupPage.class);
	...
	@Autowired
	private HQpageRequest hqpageRequst;
