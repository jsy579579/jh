...
@Controller
public class HXDHXTopupPage extends BaseChannel implements TopupRequestBusiness {
    ...
    @Autowired
    private HXDHXTopupRequest hxdhxTopupRequest;


    private static final Logger LOG = LoggerFactory.getLogger(HXDHXTopupPage.class);
    ...
    public Map<String, Object> topupRequest(Map<String, Object> params) throws Exception {
        ...
        if ("10".equals(orderType)) {
            LOG.info("进入消费计划======================");
           map = (Map<String, Object>) hxdhxTopupRequest.pay(orderCode);
        ...
        if ("11".equals(orderType)) {
            LOG.info("进入还款计划==============================");
             map = (Map<String, Object>) hxdhxTopupRequest.transferCreate(orderCode);
