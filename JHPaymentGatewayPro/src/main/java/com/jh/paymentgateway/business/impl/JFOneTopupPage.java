...
@Service
public class JFOneTopupPage extends BaseChannel implements TopupRequestBusiness {

	private static final Logger LOG = LoggerFactory.getLogger(JFOneTopupPage.class);
	@Autowired
	private TopupPayChannelBusiness topupPayChannelBusiness;

	@Autowired
	private JFXpageRequset jfxpageRequset;
	...
	public Map<String, Object> topupRequest(Map<String, Object> params) throws Exception {
		...
		JFRegister jfRegister = topupPayChannelBusiness.getJFRegisterByIdCard(idCard);*/
			...
			LOG.info("根据判断进入消费任务======");
			map = (Map<String, Object>) jfxpageRequset.register(orderCode);
