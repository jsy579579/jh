...
import com.jh.paymentgateway.controller.MHHQBpageRequest;
...
@Service
public class MHHQBTopupPage extends BaseChannel implements  TopupRequestBusiness{

	private static final Logger LOG = LoggerFactory.getLogger(MHHQBTopupPage.class);
	...
	@Autowired
	private MHHQBpageRequest hqbpageRequst;
