...
import com.jh.paymentgateway.controller.MHHQQuickpageRequest;
...
@Service
public class MHHQQuickTopupPage extends BaseChannel implements TopupRequestBusiness {

	private static final Logger LOG = LoggerFactory.getLogger(MHHQQuickTopupPage.class);
	...
	@Autowired
	private MHHQQuickpageRequest hqQuickpageRequest;
		...
		if (hqQuickRegister == null) {
			...
			if("000000".equals(respCode)) {
				...
				return ResultWrap.init(CommonConstants.SUCCESS, "成功",
						ip + "/v1.0/paymentgateway/topup/tomhhqquickpay?bankName="
