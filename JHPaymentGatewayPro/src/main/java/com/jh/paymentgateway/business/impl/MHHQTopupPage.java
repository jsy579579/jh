...
import com.jh.paymentgateway.controller.MHHQpageRequest;
import com.jh.paymentgateway.pojo.PaymentRequestParameter;
import com.jh.paymentgateway.util.Util;

@Service
public class MHHQTopupPage extends BaseChannel implements  TopupRequestBusiness{

	private static final Logger LOG = LoggerFactory.getLogger(MHHQTopupPage.class);
	...
	@Autowired
	private MHHQpageRequest hqpageRequst;
	...
	public Map<String, Object> topupRequest(Map<String, Object> params) throws Exception {
		...
		if("10".equals(orderType)) {
			...
			map = (Map<String, Object>) hqpageRequst.hqFastPay(orderCode);
		...
		if("11".equals(orderType)) {
			...
			map = (Map<String, Object>) hqpageRequst.transfer(orderCode);
