...
import com.jh.paymentgateway.controller.SSpageRequest;
...
@Service
public class SSTopupPage extends BaseChannel implements  TopupRequestBusiness{

	private static final Logger LOG = LoggerFactory.getLogger(SSTopupPage.class);
	...
	@Autowired
	private SSpageRequest sspageRequst;
	...
	public Map<String, Object> topupRequest(Map<String, Object> params) throws Exception {
		...
		if("11".equals(orderType)) {
			...
			map = (Map<String, Object>) sspageRequst.createRepayPlan(extra, bankCard, bankName, userName, phone, rate, extraFee, orderCode, ipAddress);
