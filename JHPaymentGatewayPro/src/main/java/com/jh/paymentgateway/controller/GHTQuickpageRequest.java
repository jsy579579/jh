...
public class GHTQuickpageRequest extends BaseChannel {
	private static final Logger LOG = LoggerFactory.getLogger(GHTQuickpageRequest.class);
	...
	// 绑卡申请接口
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/ghtquick/bindcard")
	public @ResponseBody Object ghtquickBindCard(HttpServletRequest request,
		...
		map.put("bgUrl", ip + "/v1.0/paymentgateway/topup/ghtquick/bindcard/notifyurl");
		...
		if ("10000".equals(dealCode) && "0".equals(needSms)) {
			...
			return ResultWrap.init("666666", "经查询您已成功鉴权绑卡,将要跳转到交易支付页面!", ip + "/v1.0/paymentgateway/topup/toghtquick/pay?bankName="
	...
	// 绑卡确认接口
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/ghtquick/bindcardconfirm")
	...
	// 快捷支付预下单接口
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/ghtquick/preorder")
	public @ResponseBody Object ghtquickPreOrder(@RequestParam(value = "orderCode") String orderCode,
		...
		map.put("merchantNo", merchantNo);
		map.put("bgUrl", ip + "/v1.0/paymentgateway/topup/ghtquick/fastpay/notifyurl");
		map.put("version", "V2.0");
		map.put("payChannelCode", bankCode);
		map.put("payChannelType", "6");// 支付通道类型 1为储蓄卡；6为信用
	...
	// 快捷确认支付接口
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/ghtquick/fastpay")
	...
	// 代付接口
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/ghtquick/transfer")
	public @ResponseBody Object transfer(@RequestParam(value = "orderCode") String orderCode,
		...
		map.put("orderAmount", bigRealAmount);
		map.put("orderTime", LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMddHHmmss")));// 订单时间);
		map.put("notifyUrl", ip + "/v1.0/paymentgateway/topup/ghtquick/transfer/notifyurl");
		map.put("orderSource", "1");
	...
	// 手动代付接口
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/ghtquick/transferbyhand")
	...
	// 代付订单查询接口
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/ghtquick/transfer/orderquery")
	...
	// 绑卡异步回调接口
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/ghtquick/bindcard/notifyurl")
	...
	// 快捷支付的异步通知
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/ghtquick/fastpay/notifyurl")
	...
	// 代付的异步通知接口
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/ghtquick/transfer/notifyurl")
	...
	// 跳转到绑卡页面
	@RequestMapping(method = RequestMethod.GET, value = "/v1.0/paymentgateway/topup/toghtquick/bindcard")
	public String returnGHTBindCard(HttpServletRequest request, HttpServletResponse response, Model model)
		...
		return "ghtquickbindcard";
	}


	@RequestMapping(method = RequestMethod.GET, value = "/v1.0/paymentgateway/topup/toghtquick/pay")
