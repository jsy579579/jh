...
public class HQBpageRequest {
	private static final Logger LOG = LoggerFactory.getLogger(HQBpageRequest.class);
	...
	//private static String merchantNo = "sl2018080218221";
	private static String merchantNo = "" +
			"shbyt2019071016";
	//private static String key = "043b1eaa";
	private static String key = "dc3becc5e60764edaa6bb78e4ac05e0e";
	...
	// 跟还款对接的接口
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/hqb/torepayment")
	public @ResponseBody Object HQBToRepayMent(HttpServletRequest request,
		...
		if (hqbBindCardByBankCard == null) {
				...
				map.put(CommonConstants.RESULT,
						ip + "/v1.0/paymentgateway/topup/tohqb/bindcard?bankName=" + URLEncoder.encode(bankName, "UTF-8")
			...
			if("000000".equals(respCode)) {
				...
				topupPayChannelBusiness.createHQBBindCard(hqbBindCardByBankCard);
	...
	// 绑卡申请接口
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/hqb/bindcard")
	public @ResponseBody Object HQBBindCard(@RequestParam(value = "bankCard") String bankCard,
		...
		trans.setNotifyUrl(ip + "/v1.0/paymentgateway/topup/hqb/bindcard/notify_call");
		...
		if("0000".equals(returncode)) {
			...
			if(hqbBindCardByBankCard != null) {
				...
				HQBBindCard hqbBindCard = new HQBBindCard();
				...
				topupPayChannelBusiness.createHQBBindCard(hqbBindCard);
	...
	// 制定代还计划的接口
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/hqb/createrepayment/task")
	public @ResponseBody Object createRepayPlan(@RequestParam(value = "extra") String extra,
		...
		trans.setNotifyUrl(ip + "/v1.0/paymentgateway/topup/hqb/fastpay/notify_call");
...
//		0-老通道,大额,支持部分银行; 
	...
	//停止代还计划的接口
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/hqb/stoprepayplan")
	...
	//查询代还计划单笔状态的接口
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/hqb/queryrepayitemstatus")
	...
	//订单查询的接口
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/hqb/orderquery")
	...
	// 查询落地商户支持省份的接口
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/hqb/queryprovince")
	...
	//查询落地商户支持城市的接口
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/hqb/querycity")
	...
	//查询银行额度限制的接口
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/hqb/querybanklimit")
	...
	//查询绑卡Id的接口
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/hqb/querytiecardid")
	...
	// 绑卡异步通知接口
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/hqb/bindcard/notify_call")
	public void hqBindCardNotifyCallback(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		if("00".equals(respCode)) {
			...
			HQBBindCard hqbBindCardByUserId = topupPayChannelBusiness.getHQBBindCardByUserId(userId);
			
			hqbBindCardByUserId.setBindId(bindId);
			hqbBindCardByUserId.setStatus("1");
			
			topupPayChannelBusiness.createHQBBindCard(hqbBindCardByUserId);
	...
	// 异步通知接口
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/hqb/fastpay/notify_call")
	...
	// 跳转到绑卡页面
	@RequestMapping(method = RequestMethod.GET, value = "/v1.0/paymentgateway/topup/tohqb/bindcard")
