...
public class HQpageRequest {
	private static final Logger LOG = LoggerFactory.getLogger(HQpageRequest.class);
	...
	// 跟还款对接的接口
		@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/hq/torepayment1")
		public @ResponseBody Object HLJCRegister(HttpServletRequest request,
			...
			HQRegister hqRegister = topupPayChannelBusiness.getHQRegisterByIdCard(idCard);

			HQBindCard hqBindCard = topupPayChannelBusiness.getHQBindCardByBankCard(bankCard);
		...
		public @ResponseBody Object HLJCRegister1(HttpServletRequest request,
				@RequestParam(value = "bankCard") String bankCard, @RequestParam(value = "idCard") String idCard,
				@RequestParam(value = "phone") String phone, @RequestParam(value = "userName") String userName,
				@RequestParam(value = "bankName") String bankName) throws Exception {
	...
	//进件接口
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/hq/register")
	public @ResponseBody Object HQRegister(@RequestParam(value = "bankName") String bankName,
		...
		trans.setNotifyUrl(ip + "/v1.0/paymentgateway/topup/hq/register/notifyurl");
		...
		if("0000".equals(jsonobj.getString("returncode"))) {
			...
			if ("SUCCESS".equalsIgnoreCase(code)) {
				...
				HQRegister hqRegister = new HQRegister();
				...
				topupPayChannelBusiness.createHQRegister(hqRegister);
	...
	//进件查询接口
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/hq/queryregister")
	...
	//同名卡开卡接口
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/hq/opencard")
	public @ResponseBody Object OpenCard(@RequestParam(value = "bankCard") String bankCard,
		...
		trans.setNotifyUrl(ip + "/v1.0/paymentgateway/topup/hq/opencard/notifyurl");
		...
		Object has_message = jsonobj.get("message");
		String message=has_message!=null?jsonobj.getString("message"):"";
		...
		if("0000".equals(returnCode)) {
			...
			if(hqBindCard == null) {
				HQBindCard hqBind = new HQBindCard();
				hqBind.setPhone(phone);
				hqBind.setIdCard(idCard);
				hqBind.setBankCard(bankCard);
				hqBind.setStatus("0");
				
				topupPayChannelBusiness.createHQBindCard(hqBind);
				
			}else {
				
				hqBindCard.setStatus("0");
				
				topupPayChannelBusiness.createHQBindCard(hqBindCard);
			}
	...
	//快捷支付接口
	@RequestMapping(method = RequestMethod.GET, value = "/v1.0/paymentgateway/topup/hq/fastpay")
	public @ResponseBody Object hqFastPay(@RequestParam(value = "orderCode") String orderCode) {
		...
		trans.setBankCardNo(bankCard);
		trans.setNotifyUrl(ip + "/v1.0/paymentgateway/topup/hq/fastpay/notifyurl");
	...
	//代付接口
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/hq/transfer")
	public @ResponseBody Object transfer(@RequestParam(value = "orderCode") String orderCode) {
		...
		trans.setNotifyUrl(ip + "/v1.0/paymentgateway/topup/hq/transfer/notifyurl");
	...
	//子商户绑卡接口
		@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/hq/bindCard")
		...
		//手动代付到储蓄卡的接口
		@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/hq/transferbymanual")
		 ...
		 * 子商户解绑卡
		 */
		/*@RequestMapping(method = RequestMethod.GET, value = "/v1.0/paymentgateway/topup/hq/UnbindCard")
		public @ResponseBody Object UnbindCard(HttpServletRequest request,
				@RequestParam(value = "orderCode") String orderCode) {
			Map<String, Object> maps = new HashMap<String, Object>();

			CommonBean trans = new CommonBean();
			PaymentRequestParameter prp = redisUtil.getPaymentRequestParameter(orderCode);
			String idCard = prp.getDebitCardNo();
			HQRegister ld = ldDpageRequstBusiness.getLDRegisterByIdCard(idCard);
			// 报文头
			trans.setVersion("0100");
			trans.setOrdersn(UUID.randomUUID().toString().replaceAll("-", ""));
			trans.setMerchno(merchno);
			...
			trans.setSubMerchantNo(ld.getMerchantNo());
			trans.setBankCardNo(ld.getBankCard());
			String result = send(trans);
			...
			if ("SUCCESS".equals(code)) {
				ld.setStatus("1");
				ldDpageRequstBusiness.createLDRegister(ld);
				LOG.info("子商户解绑卡成功");

				maps.put(CommonConstants.RESP_CODE, CommonConstants.SUCCESS);
				maps.put(CommonConstants.RESP_MESSAGE, "子商户解绑卡成功");
	...
	@RequestMapping(method = { RequestMethod.POST,
			RequestMethod.GET }, value = "/v1.0/paymentgateway/topup/hq/transfer/notifyurl")
	...
	//余额查询接口
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/hq/balancequery")
	...
	//入网异步通知
	@RequestMapping(method = { RequestMethod.POST,
			RequestMethod.GET }, value = "/v1.0/paymentgateway/topup/hq/register/notifyurl")
	public void home(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		if ("SUCCESS".equalsIgnoreCase(code)) {
			...
			HQRegister hqRegister = topupPayChannelBusiness.getHQRegisterByMerchantOrder(dsorderid);
	...
	//同名卡开卡异步通知
	@RequestMapping(method = { RequestMethod.POST,
			RequestMethod.GET }, value = "/v1.0/paymentgateway/topup/hq/opencard/notifyurl")
	...
	//同名卡交易异步通知
	@RequestMapping(method = { RequestMethod.POST,
			RequestMethod.GET }, value = "/v1.0/paymentgateway/topup/hq/fastpay/notifyurl")
