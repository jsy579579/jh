...
public class HZpageRequest extends BaseChannel {
	...
	private static final Logger LOG = LoggerFactory.getLogger(HZpageRequest.class);

	private static String key = "7becdc37ecf17870"; // 加密秘钥
	private static String merchantId = "999361048270002"; // 机构号

	
	/**
	 * 跳转到账卡页面
	 */
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/yf/toPayPage")
	public Object toPayPage(@RequestParam(value = "orderCode") String orderCode)
		...
		maps.put(CommonConstants.RESULT, ip + "/v1.0/paymentgateway/topup/hz/jump/pay?ordercode="+orderCode
				+ "&bankCard=" + cardNo
				+ "&amount=" + amount
	 ...
	 * @throws Exception
	 */
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/quick/hz/topay")
	public @ResponseBody Object topay(@RequestParam(value = "orderCode") String orderCode) throws Exception {
		...
		map.put("backNotifyUrl", ip + "/v1.0/paymentgateway/topup/hz/pay/call-back");// 异步
		...
		map.put("transChannel", "sl0");// 交易渠道sl0
	 ...
	 * @throws Exception
	 */
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/quick/tytone/queryOrder")
	...
	@RequestMapping(method = { RequestMethod.POST,
			RequestMethod.GET }, value = "/v1.0/paymentgateway/topup/hz/pay/call-back")
	 ...
	 * 中转页面
	 */
	@RequestMapping(method = RequestMethod.GET, value = "/v1.0/paymentgateway/topup/hz/jump/pay")
