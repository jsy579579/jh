...
public class JFAllpageRequset extends BaseChannel {
	...
	private static final Logger LOG = LoggerFactory.getLogger(JFAllpageRequset.class);
	protected static final Charset UTF_8 = StandardCharsets.UTF_8;
	private static String key = "CD584BBB4B3D1932CB06A87E86D248ED";
	private static String partnerNo = "002BYTH5";
	...
	// 进件注册
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/quick/jfall/register")
	public @ResponseBody Object getRegister(@RequestParam(value = "orderCode") String orderCode) throws IOException {
		...
		LOG.info(ip + "/v1.0/paymentgateway/quick/jfall/pay-view?bankName=" + URLEncoder.encode(bankName, "UTF-8")
		...
		maps.put(CommonConstants.RESULT,
				ip + "/v1.0/paymentgateway/quick/jfall/pay-view?bankName=" + URLEncoder.encode(bankName, "UTF-8")
						+ "&cardType=" + URLEncoder.encode(cardtype, "UTF-8")
						+ "&bankCard=" + bankCard
						+ "&ordercode=" + ordercode
						+ "&amount=" + amount
	 ...
	 * @throws IOException
	 */
	@RequestMapping(method = RequestMethod.GET, value = "/v1.0/paymentgateway/quick/jfall/jump-Receivablescard-view")
	public String JumpReceivablesCard(HttpServletRequest request, HttpServletResponse response, Model model)
		...
		LOG.info("/v1.0/paymentgateway/quick/jfall/jump-Receivablescard-view=========tojfbankinfo");
	 ...
	 * @throws IOException
	 */
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/quick/jfall/transfer")
	public @ResponseBody Object Transfer(@RequestParam(value = "ordercode") String orderCode,
		...
		maps.put(CommonConstants.RESP_CODE, CommonConstants.SUCCESS);
		maps.put(CommonConstants.RESP_MESSAGE, "成功");
		maps.put("redirect_url", ip + "/v1.0/paymentgateway/quick/jfall/jump-bindcard-view?ordercode=" + orderCode
	 ...
	 * @throws IOException
	 */
	@RequestMapping(method = RequestMethod.GET, value = "/v1.0/paymentgateway/quick/jfall/jump-bindcard-view")
	public String JumpBindCard(HttpServletRequest request, HttpServletResponse response, Model model)
		...
		response.setCharacterEncoding("utf-8");
		response.setContentType("text/html;charset=utf-8");
		LOG.info("/v1.0/paymentgateway/quick/jfall/jump-bindcard-view=========tojfbindcard");
	...
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/quick/jfall/open-sms")
		...
		try {
			...
			if ("000000".equals(respCode)) {
				...
				try {
					...
					maps.put(CommonConstants.RESULT, ip + "/v1.0/paymentgateway/quick/jfall/pay-view?bankName="
	 ...
	 * @return
	 */
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/quick/jfall/open-card")
	 ...
	 * @throws IOException
	 */
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/quick/jfall/pay-transfer")
	 ...
	 * @throws IOException
	 */
	@RequestMapping(method = RequestMethod.GET, value = "/v1.0/paymentgateway/quick/jfall/pay-view")
	 ...
	 * @return
	 */
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/quick/jfall/pay-sms")
	public @ResponseBody Object paySMS(@RequestParam(value = "ordercode") String orderCode) {
		...
		map.put("notifyUrl", ip + "/v1.0/paymentgateway/topup/jfall/pay/call-back?consumeOrderId=" + orderCode);
	...
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/quick/jfall/tohtml")
	public @ResponseBody Object toHtml(@RequestParam(value = "ipAddress") String ipAddress,
		...
		LOG.info( ip + "/v1.0/paymentgateway/quick/jfall/go?ipAddress=" + ipAddress
				+ "&orderCode=" + orderCode
				+ "&expiredTime=" + expiredTime
				+ "&securityCode=" + securityCode
				+ "&phone=" + phone);
		maps.put(CommonConstants.RESULT, ip + "/v1.0/paymentgateway/quick/jfall/go?ipAddress=" + ipAddress
				+ "&orderCode=" + orderCode
				+ "&expiredTime=" + expiredTime
				+ "&securityCode=" + securityCode
				+ "&phone=" + phone);
	...
	@RequestMapping(method = RequestMethod.GET, value = "/v1.0/paymentgateway/quick/jfall/go")
	public String go(HttpServletRequest request, HttpServletResponse response, Model model) throws UnsupportedEncodingException {
		LOG.info("/v1.0/paymentgateway/quick/jfall/go   进来了");
		// 设置编码
		request.setCharacterEncoding("utf-8");
		response.setCharacterEncoding("utf-8");
		response.setContentType("text/html;charset=utf-8");
	 ...
	 * @return
	 */
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/quick/jfall/fast-pay")
	public @ResponseBody Object fastPay(@RequestParam(value = "orderCode") String orderCode,
		...
		dto.put("frontUrl", ip + "/v1.0/paymentgateway/topup/jfall/pay/success");
		dto.put("notifyUrl", ip + "/v1.0/paymentgateway/topup/jfall/pay/call-back");
		dto.put("remark", "付款");
	...
	@RequestMapping(method = { RequestMethod.POST,
			RequestMethod.GET }, value = "/v1.0/paymentgateway/topup/jfall/pay/call-back")
	...
	@RequestMapping(value = "/v1.0/paymentgateway/topup/jfall/pay/success")
	 ...
	 * @return
	 */
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/quick/jfall/query-transactions")
	...
	@RequestMapping(value = "/v1.0/paymentgateway/quick/jfall/area",method = RequestMethod.GET)
	@ResponseBody
