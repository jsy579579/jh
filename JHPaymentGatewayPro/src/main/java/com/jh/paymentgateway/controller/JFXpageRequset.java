...
public class JFXpageRequset extends BaseChannel {
	...
	private static final Logger LOG = LoggerFactory.getLogger(JFXpageRequset.class);
	protected static final Charset UTF_8 = StandardCharsets.UTF_8;
	private static String key = "GEAuet26XPLaqAYnsufuKieqBXz9NiSS";
	private static String partnerNo = "F9msNmmz";
	private static String requestURL = "http://fast.jfpays.com:19087/rest/api/";// http://fast.jfpays.com:19087/rest/api/
	private static String rateCode = "101001";// 0.45%+0.5元/0.55%+0.5 （现在支持的有101001 101002）  
	 ...
	 * @return
	 */
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/quick/jfx/register")
	public @ResponseBody Object register(@RequestParam(value = "orderCode") String orderCode) throws IOException {

		LOG.info("============ 进入101001用户注册 ============");
		...
		} else if (jfxRequest.getRateOne()==null){// 用户第一次是101002进件，第二次用101001消费，无101001费率
			LOG.info("用户第一次是101002进件，第二次用101001消费，无101001费率-------------------");
			// 新增101001的费率
			maps = (Map<String, Object>) newRate(orderCode);
			String msg = (String) maps.get("resp_message");
			if ("000000".equals(maps.get("resp_code"))) {
				LOG.info("------------- 新增101001的费率 -->> 成功,判断是否需要修改101001费率或绑卡或直接交易  -------------");
				if (!rate.equals(jfxRequest.getRateOne()) | !ExtraFee.equals(jfxRequest.getExtraFeeOne())
						| !cardNo.equals(jfxRequest.getBankCard())){
					LOG.info("------------- 修改101001交易费率/结算卡/手续费 -------------");
					...
					if ("000000".equals(maps.get("resp_code"))) {
						...
						if (jfxBindCard == null) {// 已进件，未绑卡
							...
							maps.put(CommonConstants.RESULT,
									ip + "/v1.0/paymentgateway/quick/jfx/pay-view?bankName=" + URLEncoder.encode(bankName, "UTF-8")
		...
		} else if (jfxRequest.getRateTwo()==null){// 无101002费率
			LOG.info("已进件101001用户，无101002费率，进入开通101002费率-------------------");
			// 新增101002的费率
			maps = (Map<String, Object>) newRate(orderCode);
			String msg = (String) maps.get("resp_message");
			if ("000000".equals(maps.get("resp_code"))) {
				LOG.info("------------- 新增101002的费率 -->> 成功,判断是否需要修改101001费率或绑卡或直接交易  -------------");
				if (!rate.equals(jfxRequest.getRateOne()) | !ExtraFee.equals(jfxRequest.getExtraFeeOne())
						| !cardNo.equals(jfxRequest.getBankCard())){
					LOG.info("------------- 修改101001交易费率/结算卡/手续费 -------------");
					maps = (Map<String, Object>) changeRate(orderCode);
		...
		} else if (!rate.equals(jfxRequest.getRateOne()) | !ExtraFee.equals(jfxRequest.getExtraFeeOne())
				| !cardNo.equals(jfxRequest.getBankCard())) {
			LOG.info("------------- 修改101001交易费率/结算卡/手续费 -------------");
			maps = (Map<String, Object>) changeRate(orderCode);
			if ("000000".equals(maps.get("resp_code"))) {
	 ...
	 * @return
	 */
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/quick/jfx/bindCard")
	 ...
	 * @return
	 */
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/quick/jfx/confirmBindCard")
	 ...
	 * @return
	 */
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/quick/jfx/newRate")
	 ...
	 * @return
	 */
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/quick/jfx/changeRate")
	 ...
	 * @return
	 */
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/quick/jfx/fast-pay")
	public @ResponseBody Object fastPay(@RequestParam(value = "orderCode") String orderCode,
		...
		map.put("callBackUrl", ip + "/v1.0/paymentgateway/topup/jfx/pay/call-back?consumeOrderId=" + orderCode);
	 ...
	 * @return
	 */
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/quick/jfx/putPay")
	 ...
	 * 余额查询  
	 * */
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/quick/jfx/queryBalance")
	public @ResponseBody Object queryBalance(@RequestParam(value = "idCard") String idCard) {
	 ...
	 * @return
	 */
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/quick/jfx/queryFastPay")
	 ...
	 * @return
	 */
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/quick/jfx/queryPutPay")
	 ...
	 * @return
	 */
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/quick/jfx/getToken")
	 ...
	 * @throws IOException
	 */
	@RequestMapping(method = RequestMethod.GET, value = "/v1.0/paymentgateway/quick/jfx/jump-bindcard-view")
	 ...
	 * @throws IOException
	 */
	@RequestMapping(method = RequestMethod.GET, value = "/v1.0/paymentgateway/quick/jfx/pay-view")
	public String toPay(HttpServletRequest request, HttpServletResponse response, Model model) throws IOException {
		LOG.info("jfxPay------------------跳转到交易界面");
	...
	@RequestMapping(method = { RequestMethod.POST,
			RequestMethod.GET }, value = "/v1.0/paymentgateway/topup/jfx/pay/call-back")
