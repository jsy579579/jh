...
public class MHGHTDHpageRequest extends BaseChannel {
	private static final Logger LOG = LoggerFactory.getLogger(MHGHTDHpageRequest.class);
	...
	// 跟还款对接的接口
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/mhghtdh/torepayment")
	public @ResponseBody Object ghtdhToRepayment(HttpServletRequest request,
		...
		if (ghtBindCardByBankCard == null) {
			...
			return ResultWrap.init("999996", "用户需要进行绑卡授权操作",
					ip + "/v1.0/paymentgateway/topup/tomhght/bindcard?bankName=" + URLEncoder.encode(bankName, "UTF-8")
			...
			if (!"1".equals(ghtBindCardByBankCard.getStatus())) {
				...
				return ResultWrap.init("999996", "用户需要进行绑卡授权操作",
						ip + "/v1.0/paymentgateway/topup/tomhght/bindcard?bankName="
	...
	// 绑卡申请接口
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/mhghtdh/bindcard")
	public @ResponseBody Object ghtdhBindCard(HttpServletRequest request,
		...
		map.put("bgUrl", ip + "/v1.0/paymentgateway/topup/mhghtdh/bindcard/notifyurl");
	...
	// 绑卡确认接口
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/mhghtdh/bindcardconfirm")
	...
	// 快捷支付预下单接口
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/mhghtdh/preorder")
	public @ResponseBody Object ghtdhPreOrder(@RequestParam(value = "orderCode") String orderCode,
		...
		map.put("merchantNo", merchantNo);
		map.put("bgUrl", ip + "/v1.0/paymentgateway/topup/mhghtdh/fastpay/notifyurl");
		map.put("version", "V2.0");
		map.put("payChannelCode", bankCode);
		map.put("payChannelType", "6");// 支付通道类型 1为储蓄卡；6为信用
	...
	// 快捷支付接口
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/mhghtdh/fastpay")
	...
	// 代付接口
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/mhghtdh/transfer")
	public @ResponseBody Object transfer(@RequestParam(value = "orderCode") String orderCode,
		...
		map.put("orderAmount", bigRealAmount);
		map.put("orderTime", LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMddHHmmss")));// 订单时间);
		map.put("notifyUrl", ip + "/v1.0/paymentgateway/topup/mhghtdh/transfer/notifyurl");
		map.put("orderSource", "1");
	...
	// 手动代付接口
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/mhghtdh/transferbymanual")
	...
	// 支付订单查询接口
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/mhghtdh/fastpay/orderquery")
	...
	// 代付订单查询接口
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/mhghtdh/transfer/orderquery")
	...
	// 余额查询接口
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/mhghtdh/balancequery")
	...
	// 绑卡异步回调接口
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/mhghtdh/bindcard/notifyurl")
	...
	// 快捷支付的异步通知
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/mhghtdh/fastpay/notifyurl")
	...
	// 代付的异步通知接口
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/mhghtdh/transfer/notifyurl")
	...
	// 跳转到绑卡页面
	@RequestMapping(method = RequestMethod.GET, value = "/v1.0/paymentgateway/topup/tomhght/bindcard")
