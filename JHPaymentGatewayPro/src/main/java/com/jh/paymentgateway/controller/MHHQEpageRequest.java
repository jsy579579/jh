...
public class MHHQEpageRequest {
	private static final Logger LOG = LoggerFactory.getLogger(MHHQEpageRequest.class);
	...
	// 绑卡接口
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/mhhqe/bindCard")
	public @ResponseBody Object hqebindCard(@RequestParam(value = "bankCard") String bankCard,
		...
		trans.setCardType("2");
		trans.setNotifyUrl(ip + "/v1.0/paymentgateway/topup/mhhqe/opencard/notifyurl");
		...
		MHHQEBindCard hqeBindCard = topupPayChannelBusiness.getMHHQEBindCardByBankCard(bankCard);
		if ("0000".equals(returnCode)) {
			String bindUrl = jsonobj.getString("bindUrl");

			if (hqeBindCard == null) {
				MHHQEBindCard hqBind = new MHHQEBindCard();
				...
				topupPayChannelBusiness.createMHHQEBindCard(hqBind);
				...
				topupPayChannelBusiness.createMHHQEBindCard(hqeBindCard);
			}
	...
	// 快捷支付预下单接口
	@SuppressWarnings("unchecked")
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/mhhqe/prefastpay")
	public @ResponseBody Object hqePreFastPay(@RequestParam(value = "orderCode") String orderCode,
		...
		trans.setNotifyUrl(ip + "/v1.0/paymentgateway/topup/mhhqe/fastpay/notifyurl");
	...
	// 快捷支付确认下单接口
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/mhhqe/confirmfastpay")
	...
	// 代付接口
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/mhhqe/transfer")
	public @ResponseBody Object transfer(@RequestParam(value = "orderCode") String orderCode) {
		...
		trans.setNotifyUrl(ip + "/v1.0/paymentgateway/topup/mhhqe/transfer/notifyurl");
	...
	// 代付的异步通知接口
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/mhhqe/transfer/notifyurl")
	...
	// 余额查询接口
	@SuppressWarnings("unchecked")
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/mhhqe/balancequery")
	...
	// 绑卡异步通知接口
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/mhhqe/opencard/notifyurl")
	public void OpenCardBack(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		if (status.equals("00")) {
			...
			MHHQEBindCard hqeBindCardByOrderCode = topupPayChannelBusiness.getMHHQEBindCardByOrderCode(dsorderid);
			hqeBindCardByOrderCode.setBindId(bindId);
			hqeBindCardByOrderCode.setStatus("1");

			topupPayChannelBusiness.createMHHQEBindCard(hqeBindCardByOrderCode);
	...
	// 同名卡交易异步通知
	@RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/mhhqe/fastpay/notifyurl")
