 ...
 */
@RestController
public class HLBpageRequestSC {
    private static final Logger logger = LoggerFactory.getLogger(HLBpageRequestSC.class);
     ...
     * 下单接口
     */
    @RequestMapping(value = "/v1.0/paymentgateway/topup/hlb/createOrder/sc", method = RequestMethod.POST)
     ...
     * 支付回调
     */
    @RequestMapping(value = "/v1.0/paymentgateway/topup/hlb/notify/sc", method = RequestMethod.POST)
        ...
        try {
            ...
            if (checkSign.equals(responseSign)) {
                ...
                if ("SUCCESS".equals(notifyResponseVo.getRt4_status())) {
                    ...
                    URI uri = util.getServiceUrl("good", "error url request!");
                    String url = uri.toString() + "/v1.0/good/order/update";
     ...
     * 交易订单查询接口
     */
    @RequestMapping(value = "/v1.0/paymentgateway/topup/hlb/query/sc", method = RequestMethod.POST)
     ...
     * 订单退款接口
     */
    @RequestMapping(value = "/v1.0/paymentgateway/topup/hlb/refund/sc", method = RequestMethod.POST)
     ...
     * 退款查询接口
     */
    @RequestMapping(value = "/v1.0/paymentgateway/topup/hlb/refundQuery/sc", method = RequestMethod.POST)
     ...
     * 退款回调
     */
    @RequestMapping(value = "/v1.0/paymentgateway/topup/hlb/refund/notify/sc", method = RequestMethod.POST)
     ...
     * 关闭订单接口
     */
    @RequestMapping(value = "/v1.0/paymentgateway/topup/hlb/close/sc", method = RequestMethod.POST)
