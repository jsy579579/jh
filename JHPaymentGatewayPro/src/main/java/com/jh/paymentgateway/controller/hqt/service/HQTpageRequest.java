package com.jh.paymentgateway.controller.hqt.service;
...
import com.jh.paymentgateway.controller.hqt.util.SmartRepayChannel;
...
public class HQTpageRequest extends BaseChannel {
    private static final Logger LOG = LoggerFactory.getLogger(HQTpageRequest.class);

    @Autowired
    private RedisUtil redisUtil;

    @Autowired
    private HQTBusiness topupPayChannelBusiness;
     ...
     * 还款对接接口
     */
    @RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/hqt/Dockentrance")
    public @ResponseBody
    Object Dockentrance(@RequestParam(value = "bankCard") String bankCard,
        ...
        HQTbindCard hqbindCard = topupPayChannelBusiness.findHQTbindCardByBankCard(bankCard);
        HQTRegister hqregister = topupPayChannelBusiness.findHQTRegisterByIdCard(idCard);
     ...
     * @return
     */
    @RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/hqt/HQTRegister")
    public @ResponseBody
    Object hqToRegister(@RequestParam(value = "bankCard") String bankCard,
                        @RequestParam(value = "idCard") String idCard, @RequestParam(value = "phone") String phone,
        ...
        LOG.info("/hqt/HQTRegister=====================" + param.toString());
        ...
        if ("0000".equals(code) || "0052".equals(code)) {
            ...
            HQTRegister hqRegister = new HQTRegister();
            ...
            topupPayChannelBusiness.createHQTRegister(hqRegister);
    ...
    // 绑卡接口
    @RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/hqt/bindCard")
    public Object hqToBindCard(@RequestParam(value = "bankCard") String bankCard,
        ...
        LOG.info("开始绑卡==================");
        HQTbindCard hqtbind = topupPayChannelBusiness.findHQTbindCardByBankCard(bankCard);
        Map<String, Object> map = new HashMap<>();
        ...
        param.put("notifyUrl", ip + "/v1.0/paymentgateway/topup/hqt/bindcard/call_back");// 异步通知地址
        LOG.info("/hqt/bindCard=====================" + param.toString());
        Map<String, String> resultMap = smart.allRequestMethod(param);
        LOG.info("=============环球小额落地：" + resultMap.toString());
        ...
        if ("0000".equals(code) || "0055".equals(code)) {
            if (resultMap.containsKey("bindId")) {
                ...
                HQTbindCard hqBindCard = new HQTbindCard();
                ...
                topupPayChannelBusiness.createHQTbindCard(hqBindCard);
                map.put(CommonConstants.RESP_CODE, CommonConstants.SUCCESS);
            ...
            if (resultMap.containsKey("bindUrl")) {
                ...
                if (hqtbind == null) {
                    ...
                    topupPayChannelBusiness.createHQTbindCard(hqBindCard);
                } else if ("0".equals(hqtbind.getStatus())) {
                    hqtbind.setOrderId(dsorderid);
                    topupPayChannelBusiness.createHQTbindCard(hqtbind);
                }
    ...
    @RequestMapping(method = {RequestMethod.POST,
            RequestMethod.GET}, value = "/v1.0/paymentgateway/topup/hqt/bindcard/call_back")
    public void bindcardNotify(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if ("00".equals(status)) {
            LOG.info("*********************绑卡成功***********************");
            HQTbindCard HQTbindCard = topupPayChannelBusiness.getHQXBindCardByOrderId(dsorderid);
            HQTbindCard.setBindId(bindId);
            HQTbindCard.setStatus("1");
            HQTbindCard.setUpdateTime(new Date());
            topupPayChannelBusiness.createHQTbindCard(HQTbindCard);
     ...
     * @return
     */
    @RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/hqt/updateRate")
    public Object changeRate(@RequestParam(value = "idCard") String idCard,
        ...
        LOG.info("/hqt/updateRate==========" + request.toString());
     ...
     * @return
     */
    @RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/hqt/topay")
    public Object topay(@RequestParam(value = "orderCode") String orderCode) throws Exception {
        ...
        try {
            ...
            LOG.info("=======================================hqt消费城市编码：" + provinceCode);
        } catch (Exception e) {
            e.printStackTrace();
        ...
        // param.put("mcc", "");//行业x
        LOG.info("hqt/topay==========" + param.toString());
        param.put("notifyUrl", ip + "/v1.0/paymentgateway/topup/hqt/pay/call_back"); // 异步通知地址
        Map<String, String> resultMap = smart.allRequestMethod(param);
        LOG.info("=============环球小额落地：" + resultMap.toString());
        String errtext = resultMap.get("errtext");
        String code = resultMap.get("returncode"); // 返回码
    ...
    // 消费交易异步通知
    @RequestMapping(method = {RequestMethod.POST,
            RequestMethod.GET}, value = "/v1.0/paymentgateway/topup/hqt/pay/call_back")
...
//            }
     ...
     * @return
     */
    @RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/hqt/transfer")
    public Object transfer(@RequestParam(value = "orderCode") String orderCode) throws Exception {
        ...
        request.put("notifyUrl", ip + "/v1.0/paymentgateway/topup/hqt/transfer/call_back"); // 异步通知地址
        LOG.info("/hqt/transfer================" + request.toString());
        Map<String, String> resultMap = smart.allRequestMethod(request);
        LOG.info("=============环球小额落地：" + resultMap.toString());
    ...
    // 代付交易异步通知
    @RequestMapping(method = {RequestMethod.POST,
            RequestMethod.GET}, value = "/v1.0/paymentgateway/topup/hqt/transfer/call_back")
...
//            }
    ...
    @ResponseBody
    @RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/hqt/balanceQuery1")
     ...
     */
    @ResponseBody
    @RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/hqt/balanceQuery")
    public Object balanceQuery(@RequestParam(value = "bankCard") String bankCard,
                               @RequestParam(value = "idCard") String idCard) throws Exception {
        LOG.info("开始进入商户余额查询========================");
        Map<String, Object> map = new HashMap<>();
        HQTbindCard HQTbindCard = topupPayChannelBusiness.findHQTbindCardByBankCard(bankCard);
        HQTRegister HQTRegister = topupPayChannelBusiness.findHQTRegisterByIdCard(idCard);
        String bindId = HQTbindCard.getBindId();
        String subMerchantNo = HQTRegister.getMerchantCode();
     ...
     */
    @ResponseBody
    @RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/hqt/payQuery")
