//package com.jh.paymentgateway.controller.hx2.service;
//
//
...
//
//@Controller
//public class HXDHXTopupRequest2 extends BaseChannel {
//
//    private static final Logger LOG = LoggerFactory.getLogger(HXDHXTopupRequest2.class);
//
...
//
//    private final static String agencyType = "fx";
//
...
//    @RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/hxdhx2/dockingEntrance")
//    public @ResponseBody
...
//
//    //下单接口
//    @RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/hxdhx2/Precreate")
//    public @ResponseBody
...
//        obj.put("notifyUrl", ipAddress + "/v1.0/paymentgateway/topup/hxdhx2/transfer/notifyurl"); //TODO 回调地址
...
//
//    // 交易查询接口
//    @RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/hxdhx2/orderquery")
...
//    // 代付的异步通知接口
//    @ResponseBody
//    @RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/hxdhx2/transfer/notifyurl")
...
//
//    // 环迅结算接口
//    @RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/hxdhx2/transfercreate")
//    public @ResponseBody
...
//    }
//    //结算查询接口
//    @RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/hxdhx2/transferquery")
...
//        return  maps;
//    }
//    @RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/hxdhx2/balancequery1")
...
//
//    //环迅余额查询接口
//    @RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/hxdhx2/balancequery")
...
//    //环迅获取城市列表
//    @ResponseBody
//    @RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/hxdhx2/getcity")
...
//
//
//    @RequestMapping(method = RequestMethod.POST, value = "/v1.0/paymentgateway/topup/hxdhx2/querybycity")
//    @ResponseBody
