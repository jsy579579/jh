package com.jh.paymentgateway.util.XTZFutil;
...
public class XTZFutil {
    ...
    public static String sign(Map<String,String> params) throws Exception{
        ...
        String key = "75C1A95443014B2EBDC4487EAD9E919B";
        ...
        System.out.println("md5加密data = " + s);
        String sign = md5(s.getBytes());
//        String sign = getMD5(s).toUpperCase();
