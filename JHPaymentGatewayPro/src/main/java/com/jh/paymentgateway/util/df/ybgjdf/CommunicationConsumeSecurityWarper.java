...
public class CommunicationConsumeSecurityWarper {
	 ...
	 * @return util.RSA.digitalPrivateKeySign(text, privatekeypartner);
	 */
	public static String getSignB64PlainTextByPartnerPrivateKey(String plainText ,  PrivateKey partnerPrivateKey ) throws UnsupportedEncodingException {
	 ...
	 * @return
	 */
	public static String getCipherB64AESKeyByplatformPublicKey(String partnerAESKey, PublicKey platformPublicKey) throws UnsupportedEncodingException {
