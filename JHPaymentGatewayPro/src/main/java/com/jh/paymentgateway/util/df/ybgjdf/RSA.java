...
public class RSA {
    ...
    public static byte[] publicKeyEncrypt(String plainText, PublicKey publicKey) throws UnsupportedEncodingException {
		
		return publicKeyEncrypt(plainText, publicKey,  keyLength,  reserveSize);
		
	}
	
	public static byte[] publicKeyEncrypt(String plainText, PublicKey publicKey, int keyLength, int reserveSize) throws UnsupportedEncodingException {
	...
	public static String privateKeyDecrypt(byte[] encryptedBytes, PrivateKey privateKey) throws UnsupportedEncodingException {
		return privateKeyDecrypt( encryptedBytes,  privateKey,  keyLength,  reserveSize);
	 }
	
	public static String privateKeyDecrypt(byte[] encryptedBytes, PrivateKey privateKey, int keyLength, int reserveSize) throws UnsupportedEncodingException {
		return new String(privateKeyDecrypt( encryptedBytes,  privateKey,  keyLength,  reserveSize,  cipherAlgorithm) ,"utf-8");
	 }
	...
	public static  byte[] digitalPrivateKeySign(String plainText, PrivateKey privateKey) throws UnsupportedEncodingException {
	...
	public static byte[] digitalPrivateKeySign(byte[] plainBytes, PrivateKey privateKey, String signAlgorithm)  {
	 ...
	 public static boolean verifyPublicKeyDigitalSign(String plainText, byte []  signBytes, PublicKey publicKey) throws UnsupportedEncodingException {
		byte [] plainBytes =  getUTF8Bytes(plainText);
