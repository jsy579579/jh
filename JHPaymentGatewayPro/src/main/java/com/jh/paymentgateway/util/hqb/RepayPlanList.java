...
//    扣款记录对应还款记录的订单号，代还模式为2时必填，如果是扣款记录则填此扣款记录对应的还款记录的合作商单笔订单号，如果是还款记录则填此还款记录的单笔订单号  
	...
	public String toString() {
		return "RepayPlanList [tradeTime=" + tradeTime + ", transferTime=" + transferTime + ", tradeMoney=" + tradeMoney
				+ ", transferMoney=" + transferMoney + ", rateMoney=" + rateMoney + ", repayOrderId=" + repayOrderId
				+ ", transferRepayOrderId=" + transferRepayOrderId + ", repayOrderFlag=" + repayOrderFlag + ", mcc="
				+ mcc + ", trade_time=" + trade_time + ", transfer_time=" + transfer_time + ", trade_amount="
				+ trade_amount + ", transfer_amount=" + transfer_amount + ", fee=" + fee + ", repay_item_type="
				+ repay_item_type + ", cooperator_item_id=" + cooperator_item_id + ", cooperator_transfer_item_id="
