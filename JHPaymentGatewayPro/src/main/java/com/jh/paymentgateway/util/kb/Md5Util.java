...
public class Md5Util {
    ...
    public String getkeyBeanofStr(String inbuf) {
        this.keyBeanInit();
        this.keyBeanUpdate(inbuf.getBytes(), inbuf.length());
        this.keyBeanFinal();
        this.digestHexStr = "";
    ...
    private void keyBeanUpdate(byte[] inbuf, int inputLen) {
        ...
        int i;
        if (inputLen >= partLen) {
            this.keyBeanMemcpy(this.buffer, inbuf, index, 0, partLen);
            this.keyBeanTransform(this.buffer);

            for(i = partLen; i + 63 < inputLen; i += 64) {
                this.keyBeanMemcpy(block, inbuf, 0, i, 64);
                this.keyBeanTransform(block);
            }
        ...
        this.keyBeanMemcpy(this.buffer, inbuf, index, i, inputLen - i);
    }
    ...
    private void keyBeanFinal() {
        ...
        this.keyBeanUpdate(PADDING, padLen);
        this.keyBeanUpdate(bits, 8);
