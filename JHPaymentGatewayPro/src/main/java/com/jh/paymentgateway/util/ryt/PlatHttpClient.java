...
public class PlatHttpClient {
	...
	public static boolean postAndGetStatus(Map<String,String>reqData,String reqUrl,String encoding){
		//发送请求
		...
		try {
			...
			if(200==status){
				...
				if(StringUtils.isNotBlank(resultString)&&resultString.equalsIgnoreCase("success")){
					return true;
				}
				return false;
			}
