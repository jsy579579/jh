...
public class WechatH5Request {
    ...
    private WxH5SceneInfo sceneInfo;
    ...
    public WechatH5Request(String outTradeNo, String customerCode, String terminalNo, String clientIp, WechatH5OrderInfo orderInfo,
                     ...
                     String attachData, String transactionStartTime, String transactionEndTime, WxH5SceneInfo sceneInfo) {
    ...
    public WxH5SceneInfo getSceneInfo() { return sceneInfo; }
    public void setSceneInfo(WxH5SceneInfo sceneInfo) { this.sceneInfo = sceneInfo; }
