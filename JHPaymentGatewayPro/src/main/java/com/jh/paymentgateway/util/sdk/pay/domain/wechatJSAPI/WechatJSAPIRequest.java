package com.jh.paymentgateway.util.sdk.pay.domain.wechatJSAPI;
...
public class WechatJSAPIRequest {
	...
	private WxJsOrderInfo orderInfo;
	...
	public WechatJSAPIRequest(String outTradeNo, String customerCode, String terminalNo, String clientIp,
			WxJsOrderInfo orderInfo, long payAmount, String payCurrency, String channelType, String notifyUrl,
	...
	public WxJsOrderInfo getOrderInfo() {
		return orderInfo;
	}

	public void setOrderInfo(WxJsOrderInfo orderInfo) {
		this.orderInfo = orderInfo;
	}
