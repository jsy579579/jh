...
//                    method.addParameter(key, value);
                ...
                try {
                    ...
                    System.out.println("Fatal transport error while try connect to [" + url + "]");
     ...
     */
    public int submit_backCode_https(Object obj) throws CommunicationException, NoSuchAlgorithmException, KeyManagementException {
...
//                    method.addParameter(key, value);
    ...
    public String submit(Object obj) throws CommunicationException {
        ...
        if (statusCode != HttpStatus.SC_OK) {
            System.out.println("Answer from [" + url + "] status code: [" + statusCode + "]");
