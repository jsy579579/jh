...
@Entity
@Table(name = "t_sign_common_coin")
public class SignCommonCoin implements Serializable {
	...
	public String toString() {
		return "SignCommonCoin [id=" + id + ", brandId=" + brandId + ", grade=" + grade + ", gradeName=" + gradeName
