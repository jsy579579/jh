...
public class RedisUtil {
	 ...
	 * @return
	 */
	public List<UserManagement> getUserManagement(String key) {
		List<UserManagement> result = (List<UserManagement>) redisTemplate.opsForValue().get(key);
		if (result == null) {
			return null;
		}
		return result;
	 ...
	 * @return
	 */
	public boolean set(String key, List<UserManagement> value) {
